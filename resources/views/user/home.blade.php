...
@section('mainContent')
        ...
        <div class="container">
            ...
            <div class="stats-info agileits w3layouts">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 agileits w3layouts stats-grid stats-grid-2">
                    ...
                    <div class="stat-info-w3ls">
                        <h4 class="agileits w3layouts ">House Owner</h4>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 stats-grid agileits w3layouts stats-grid-4">
                    ...
                    <div class="stat-info-w3ls">
                        <h4 class="agileits w3layouts">Divisions</h4>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
    ...
    <div class="event-more" id="evennts">
        <div class="container">
            <h3 class="title-w3-agile">Houses</h3>
    ...
    <div class="event-more" id="recommendation">
        <div class="container">
            <h5 class="title-w3-agile">House Recommendation</h5>
            <div class="w3_agile_grids">
        ...
        {{--<div class=" pope banner-agileits-btm" id="video">--}}
            ...
            {{--<div id="small-dialog1" class="mfp-hide w3ls_small_dialog wthree_pop">--}}
                {{--<div class="agileits_modal_body">--}}
                    {{--<iframe src="https://player.vimeo.com/video/106770833"></iframe>--}}
                {{--</div>--}}
            {{--</div>--}}
        {{--</div>--}}
        ...
        {{--<div class="matter">--}}
            ...
            {{--<div class="some-text">--}}
                {{--<p>--}}
                    ...
                    {{--elit, sed do eiusmod tempor incididunt ut minim veniam,--}}
    ...
    <div class="team" id="team">
        ...
        <div class="container">
            <h3 class="title-w3-agile">Nearest Owner</h3>

            <div class="agileits-team-grids">
                @if(isset($nearestowners))
                    <?php
                    $i = 1;
                    ?>
                    @foreach($nearestowners as $owner)
                            <a href="{{url('user/house-post'.'/'.$owner->id)}}">
                        <div class="col-md-3  col-sm-6 col-xs-6 agileits-team-grid top">
                            <div class="team-info">
                                <img src="{{asset($owner->picture)}}" alt="" style="height: 250px">
                                <div class="team-caption">
                                    <h4>{{$owner->name}}</h4>
                                    <p>{{$owner->address}} , {{$owner->district}}</p>
                                    <p>{{$owner->email}}</p>
                                    <p>{{$owner->contract}}</p>
                                    <ul>
